...
while True:
    ...
    if state == STANDBY:
        ...
        if buttonB_toggle == True:
            ...
            if camera_mode == 1:
                ...
                if end_effector_motor.torque(TorqueUnits.NM) > 0.5:
                    ...
                    camera_mode = 2
            if camera_mode == 2:
                if m_target_fruit == "purple":
                    m_color_to_bin_id = 20
                elif m_target_fruit == "green":
                    m_color_to_bin_id = 21
                elif m_target_fruit == "orange":
        ...
        m_x = m_c_fo_X + m_atat_ro_X + m_ato_ro_X + m_gtb_atat_ro_X
        m_y = m_c_fo_Y + m_atat_ro_Y + m_ato_ro_Y + m_gtb_atat_ro_Y
        m_rot = m_atat_rot + m_ato_rot + m_c_rot + m_gtb_atat_rot
