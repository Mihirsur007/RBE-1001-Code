...
while True:
    ...
    if state == STANDBY:
        ...
        m_x = m_c_fo_X + m_atat_ro_X
        m_y = m_c_fo_Y + m_atat_ro_Y
        m_rot = m_atat_rot + m_c_rot
    ...
    # Auto mode = runs a program and stops after some time ----
        ...
        m_gtb_atat_ro_X, m_gtb_atat_ro_Y = field_oriented(m_gtb_atat_strafe_X, m_gtb_atat_strafe_Y, 0)
        a_gtb_ro_X, a_gtb_ro_Y = field_oriented(a_gtb_atat_strafe_X, a_gtb_atat_strafe_Y, 0)
        a_m_ro_X, a_m_ro_Y = field_oriented(0, a_ramp_Y, current_heading)

        m_x = a_gtb_ro_X + a_m_ro_X + m_ato_ro_X + m_gtb_atat_ro_X
        m_y = a_gtb_ro_Y + a_m_ro_Y + m_ato_ro_Y + m_gtb_atat_ro_Y
